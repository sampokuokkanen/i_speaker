...
class TestAIInput
  ...
  def simulate_improved_input
    ...
    unless additional_context.strip.empty?
      full_context += "\n\nAdditional context: #{additional_context}"
    end
    puts full_context.light_blue
    
    return title, description, additional_context, full_context
  end
  ...
  def demonstrate_ai_prompt_improvement(title, description, additional_context)
    ...
    new_prompt = <<~PROMPT
      ...
      #{additional_context.strip.empty? ? "" : "Additional context: #{additional_context}"}
      Audience: #{audience}
      Duration: #{duration} minutes
...
title, description, additional_context, full_context = demo.simulate_improved_input
